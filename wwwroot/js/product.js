(function () {
    ...
    app.controller("manageDesign", function ($scope, $location, $http, $log, customfields) {
        $scope.customFields = [];
        ...
        $scope.save = function () {
            ...
            $scope.message = $http.post('http://danishtest.ml/api/product/addproduct', $scope.product).
    ...
    app.controller("getProduct", function ($scope, $http, $log, $rootScope, $location) {
        ...
        $scope.message = $http.post('http://danishtest.ml/api/product/getproduct', $rootScope.ProductId).
            then(function (response) {
        ...
        $scope.deleteProduct = function (x) {
            $scope.message = $http.post('http://danishtest.ml/api/product/deleteproduct', x).
                then(function (response) {
    ...
    app.controller('editPController', function ($scope, $rootScope, $http) {
        ...
        $scope.edit = function () {
            $scope.message = $http.post('http://danishtest.ml/api/product/editproduct', $scope.products).
                then(function (response) {
                    console.log(response.data);
                });
        }
