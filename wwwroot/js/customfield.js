(function () {
  ...
  app.controller("addcustom", function ($scope, $http) {
    ...
    $scope.save = function () {
      $scope.custom.id = 0;
      $scope.message = $http.post('http://danishtest.ml/api/customfield/addCustomField', $scope.custom).
  ...
  app.controller("getcustom", function ($scope, $http, $rootScope, $location) {
    ...
    $scope.message = $http.post('http://danishtest.ml/api/customfield/getCustomFieldById', $rootScope.customId).
      then(function (response) {
    ...
    $scope.deleteCustom = function (x) {
      $scope.message = $http.post('http://danishtest.ml/api/customfield/deleteCustomFieldById', x).
        then(function (response) {
  ...
  app.controller('editCFController', function ($scope, $rootScope, $http,$location) {
    ...
    $scope.edit = function () {
      $scope.message = $http.post('http://danishtest.ml/api/customfield/editCustomField', $scope.customs).
        then(function (response) {
          console.log(response.data);
          console.log($scope.customs);
          $location.path('/customs');
