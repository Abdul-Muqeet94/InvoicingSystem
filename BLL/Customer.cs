...
namespace SimpleInvoices.BLL
{
    ...
    public class Customers
    {
        ...
        public BaseResponse addCustomer(UserViewReq customer)
        {
            ...
            var db = _db;
            SimpleInvoices.Customer Customer=new SimpleInvoices.Customer();
            if(customer.email !=null)
            {
              Customer = db.customer.Where(c => c.email.Equals(customer.email)).FirstOrDefault();
            }
            else
            {
               Customer=null;
            ...
            if (Customer == null)
            {
                ...
                cust.additionalNotes=customer.additionalNotes;
